...
COMPILER_OPTIONS := /Fo$(BUILD_DIR) /Fe$(EXE_FILE) /Fd$(BUILD_DIR) /I$(INC_DIR)
COMPILER_OPTIONS += /nologo /WX /W4 /wd4100 /wd4201 /wd4245 /wd4189 /wd4459
COMPILER_OPTIONS += /D_CRT_SECURE_NO_WARNINGS

COMPILER_OPTIONS_DEBUG := $(COMPILER_OPTIONS) /DEBUG:FULL /Zi
COMPILER_OPTIONS_RELEASE := $(COMPILER_OPTIONS)

LINKER_OPTIONS = /link user32.lib gdi32.lib wininet.lib shell32.lib /subsystem:windows /MANIFEST:EMBED "/manifestdependency:type='win32' name='Microsoft.Windows.Common-Controls' version='6.0.0.0' processorArchitecture='*' publicKeyToken='6595b64144ccf1df' language='*'"
